...
},
{
  ...
  "number": "2.5.1",
  "title": "",
  "body": "  写像 が 単射(injective) であるとは、 が成り立つことである。 が 全射(surjective, onto) であるとは、任意の となるような が存在することである。 逆像(inverse image) が空集合でないと言い換えてもよい。 全単射(bijective) であるとは、全射かつ単射であることをいう。   "
},
{
  "id": "group-theory",
  "level": "1",
